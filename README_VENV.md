# Virtual Environment Setup (gps-time-syc-vk172)

Follow these steps to create and activate the Python virtual environment for the project.

## 1. Create the Environment

From the project root (`/home/rob/gps-time-syc-vk172`):
...
- When using `sudo`, specify full paths to the venv executables (e.g., `/home/rob/gps-time-syc-vk172/.venv/bin/gps-time-sync`) to avoid “command not found” errors.
